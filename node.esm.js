...
var $;
(function ($) {
    class $hyoo_when extends $mol_book2 {
        Placeholder() {
            return null;
        }
        store() {
        ...
        Joined_name(id) {
            ...
            obj.checked = (next) => this.joined_allow(id, next);
            return obj;
        }
        Theme() {
        ...
        Join() {
            const obj = new this.$.$mol_check_box();
            obj.checked = (next) => this.join(next);
        ...
        Calendar(month) {
            const obj = new this.$.$mol_date_calendar();
            obj.month_moment = () => this.calendar_month(month);
            obj.day_holiday = (day) => this.day_bingo(day);
            obj.day_selected = (day) => this.day_selected(day);
            obj.day_click = (day, event) => this.day_click(day, event);
            return obj;
        }
        List() {
            ...
            obj.after = (month) => this.calendars_after(month);
            obj.Row = (month) => this.Calendar(month);
            return obj;
        }
        Schedule() {
            const obj = new this.$.$mol_page();
    ...
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "store", null);
    __decorate([
        $mol_mem_key
    ], $hyoo_when.prototype, "Joined_name", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "Theme", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "New_icon", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "New_link", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "Github", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "Lights", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "Schedule_icon", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "Schedule_link", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "descr", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "Descr", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "Joined", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "name", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "Name", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "join", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "Join", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "Main", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "Schedule_close_icon", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "Schedule_close", null);
    __decorate([
        $mol_mem_key
    ], $hyoo_when.prototype, "calendar_month", null);
    __decorate([
        $mol_mem_key
    ], $hyoo_when.prototype, "day_click", null);
    __decorate([
        $mol_mem_key
    ], $hyoo_when.prototype, "Calendar", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "List", null);
    __decorate([
        $mol_mem
    ], $hyoo_when.prototype, "Schedule", null);
    __decorate([
        $mol_mem_key
    ], $hyoo_when.prototype, "joined_allow", null);
    $.$hyoo_when = $hyoo_when;
})($ || ($ = {}));
//hyoo/when/-view.tree/when.view.tree.ts
;
"use strict";
var $;
(function ($) {
    $mol_style_attach("hyoo/when/when.view.css", "[hyoo_when_main] {\n\tflex: 1 0 40rem;\n}\n\n[hyoo_when_main_body] {\n\tpadding: var(--mol_gap_block);\n}\n\n[hyoo_when_main_foot] {\n\tpadding: var(--mol_gap_block);\n}\n\n[hyoo_when_calendar] {\n\tmargin: var(--mol_gap_block);\n}\n\n[hyoo_when_joined] {\n\tflex-wrap: wrap;\n}\n\n[hyoo_when_calendar_day][mol_calendar_holiday] {\n\tcolor: yellow;\n}\n");
})($ || ($ = {}));
//hyoo/when/-css/when.view.css.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        class $hyoo_when extends $.$hyoo_when {
            new_link() {
        ...
        __decorate([
            $mol_mem
        ], $hyoo_when.prototype, "meet", null);
        __decorate([
            $mol_mem
        ], $hyoo_when.prototype, "descr", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_when.prototype, "person", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_when.prototype, "person_name", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_when.prototype, "joined_available", null);
        __decorate([
            $mol_mem
        ], $hyoo_when.prototype, "pages", null);
        __decorate([
            $mol_mem
        ], $hyoo_when.prototype, "joined", null);
        __decorate([
        ...
        __decorate([
            $mol_mem
        ], $hyoo_when.prototype, "joined_names", null);
        __decorate([
            $mol_mem
        ], $hyoo_when.prototype, "joined_allowed", null);
        __decorate([
            $mol_mem
        ], $hyoo_when.prototype, "bingos", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_when.prototype, "day_bingo", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_when.prototype, "day_selected", null);
        $$.$hyoo_when = $hyoo_when;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//hyoo/when/when.view.ts
;
export default $
